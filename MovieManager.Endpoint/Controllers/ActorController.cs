...
namespace MovieManager.Endpoint.Controllers
{
    ...
    public class ActorController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("/actors/ranges")]
        public ActionResult GetByRange([FromBody] ActorRangeRequest actorRangeRequest)
        {
            var actors = _actorService.GetByRange(
        ...
        [HttpGet]
        [Route("/actors/like")]
        public ActionResult GetLikedActors()
        {
            var actors = _actorService.GetLikedActors();
            if (actors.Count > 0)
            {
                return Ok(actors);
            }
